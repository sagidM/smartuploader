...
return results},waitingToUploadCount:function(){return workers.length}}};uploadImageFiles=function(dropZone,fileInput,workers,files,options){var accept,action,actionOption,anyIsInvalid,blobs,dotPos,droppedFiles,ext,file,filenames,i,ignore,isValid,isValidFile,j,k,kids,len,mimeTypeMatcher,msize,multiUploading,name,nameMatcher,preview,previewContainer,progressBar,ref,uploadNext,uploadedFilesCount;workers.length=0;dropZone.classList.remove('hover');dropZone.classList.remove('drop');dropZone.classList.remove('error');previewContainer=dropZone.getElementsByClassName("preview-container")[0];if(previewContainer){previewContainer.innerHTML=""}
